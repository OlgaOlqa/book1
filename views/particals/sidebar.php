        ...
        <aside class="widget">
            ...
            <?php foreach($popular as $article): ?>
                <div class="popular-post">
                    <a href="<?= Url::toRoute(['site/view', 'id' => $article->id]); ?>" class="popular-img"><img src="uploads/<?php echo $article['image']?>" alt="">
        ...
        <aside class="widget border pos-padding">
            ...
            <ul>
                <?php foreach($categories as $category): ?>
                    <li>
                        <a href="<?= Url::toRoute(['site/category', 'id' => $category->id]); ?>"> <?= $category->getArticleCount(); ?> </a>
